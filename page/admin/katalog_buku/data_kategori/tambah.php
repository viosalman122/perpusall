...
<body>
    ...
    <div class="cardBox">
        <div class="title-pages">
            <ion-icon name="book-outline"></ion-icon> TAMBAH KATEGORI</i>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3" method="POST">
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Kode Kategori <span style="color: red">* wajib di isi</span></label>
                            <input type="text" class="form-control" name="kode" required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Nama Kategori <span style="color: red">* wajib di isi</span></label>
