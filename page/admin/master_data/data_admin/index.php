...
<body>
    ...
    <div class="cardBox">
        <div class="title-pages">
            <ion-icon name="book-outline"></ion-icon> DATA ADMIN</i>
        </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="color: blue;"><?= $a["join_date"] ?></td>
                            <td class="mb-3">
                                <a class="btn-edit mb-3" href="edit.php?id=<?= $a["id"] ?>">
