...
$anggota = new User;
$data_user_edit = $anggota->find($id_edit);
...
if (isset($_POST["submit"])) {
    ...
    $anggota->updateByAdmin($id_edit, $data);
...
<body>
    ...
    <div class="cardBox">
        <div class="title-pages">
            <ion-icon name="book-outline"></ion-icon> EDIT ANGGOTA</i>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3" method="POST">
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Kode Anggota <span style="color: red">*</span></label>
                            <input type="text" class="form-control" name="kode" value="<?= $data_user_edit["kode"] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">NIS <span style="color: red">*</span></label>
                            <input type="text" class="form-control" name="nis" value="<?= $data_user_edit["nis"] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Nama Anggota <span style="color: red">*</span></label>
                            <input type="text" class="form-control" name="fullname" value="<?= $data_user_edit["fullname"] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Username <span style="color: red">*</span></label>
                            <input type="text" class="form-control" name="username" value="<?= $data_user_edit["username"] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Password <span style="color: red">*</span></label>
                            <input type="password" class="form-control" name="password" value="<?= $data_user_edit["password"] ?>" disabled>
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Kelas <span style="color: red">*</span></label>
                            <input type="text" class="form-control" name="kelas" value="<?= $data_user_edit["kelas"] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">Alamat <span style="color: red">*</span></label>
                            <input type="text" class="form-control" name="alamat" value="<?= $data_user_edit["alamat"] ?>">
                        </div>
                        <div class="mb-3">
