...
if (isset($_POST["submit"])) {
    ...
    $user = new User;
    $submit = $user->createAnggota($data);
...
<body>
    ...
    <div class="cardBox">
        <div class="title-pages">
            <ion-icon name="book-outline"></ion-icon> TAMBAH ANGGOTA</i>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="row g-3" method="POST">
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Kode Anggota <span style="color: red">* wajib di isi</span></label>
                            <input type="text" class="form-control" name="kode" required>
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">NIS <span style="color: red">* wajib di isi</span></label>
                        ...
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Kelas <span style="color: red">* wajib di isi</span></label>
                            <input type="text" class="form-control" name="kelas" required>
                        </div>
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">Alamat <span style="color: red">* wajib di isi</span></label>
