...
$data_penerbit_edit = $penerbit->find($id_edit);
...
<body>
    ...
    <div class="cardBox">
        <div class="title-pages">
            <ion-icon name="book-outline"></ion-icon> EDIT PENERBIT</i>
        </div>
                ...
                <div class="card-body">
                    <form class="row g-3" method="POST">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="kode" value="<?= $data_penerbit_edit["kode"] ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="inputPassword4" class="form-label">Nama Penerbit <span style="color: red">*</span></label>
                            <input type="text" class="form-control" name="nama" value="<?= $data_penerbit_edit["nama"] ?>">
                        </div>
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">Status <span style="color: red">*</span></label>
                            <input type="text" class="form-control" name="verif" value="<?= $data_penerbit_edit["verif"] ?>">
                        </div>
                        <div class="col-12">
